...
export default {
  ...
  siteProfile: {
    ...
    tlsNoSnapshot: 'Certificate not in local snapshot',
    tlsNoSnapshotDetail: 'This site is not in the public-sector snapshot.',
    scanThisSite: 'Scan this site',
    scanNotYetAvailable: 'On-demand scan not yet available',
    scanScanning: 'Scanning…',
    scanExpired: 'Certificate has expired',
    scanError: 'Scan failed — certificate could not be read',
    scanCa: 'CA',
    scanValidation: 'Validation',
    scanExpiry: 'Expires',
    scanExpiryDays: '{days} days',
    sendReport: 'Send report to Attestto',
