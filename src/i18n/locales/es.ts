...
export default {
  ...
  siteProfile: {
    ...
    tlsNoSnapshot: 'Certificado no está en el muestreo local',
    tlsNoSnapshotDetail: 'Este sitio no está en el muestreo del sector público.',
    scanThisSite: 'Escanear este sitio',
    scanNotYetAvailable: 'Escaneo bajo demanda aún no disponible',
    scanScanning: 'Escaneando…',
    scanExpired: 'El certificado ha vencido',
    scanError: 'Escaneo fallido — no se pudo leer el certificado',
    scanCa: 'CA',
    scanValidation: 'Validación',
    scanExpiry: 'Vence',
    scanExpiryDays: '{days} días',
    sendReport: 'Enviar reporte a Attestto',
  ...
  siteHealth: {
    sectionTitle: 'Salud del sitio',
    localAnalysisNote: 'Analizado localmente en su navegador. Nada sale de este dispositivo.',
    ok: 'OK',
    yes: 'Sí',
    no: 'No',
    none: 'Ninguno',
    ...
    analyzeError: 'No se pudo analizar esta página',
    security: {
      title: 'Seguridad',
      https: 'Servido por HTTPS',
      mixedContent: 'Referencias a recursos inseguros',
      unsafeForms: 'Formularios con destino inseguro',
      passwordOnHttp: 'Campo de contraseña en página HTTP',
      blankNoOpener: 'Vínculos inseguros de abrir en nueva pestaña',
    },
    a11y: {
      title: 'Accesibilidad',
      imgAlt: 'Imágenes sin texto alternativo',
      inputLabels: 'Campos sin etiquetas',
      htmlLang: 'Idioma de página declarado',
      h1Count: 'Encabezados H1',
      headingSkip: 'Niveles de encabezado omitidos',
      ariaLandmarks: 'Regiones de referencia',
    },
    meta: {
      title: 'Identidad de página',
      pageTitle: 'Título de página',
      chars: 'chars',
      description: 'Meta descripción',
      canonical: 'URL canónica',
      favicon: 'Favicon',
      openGraph: 'Etiquetas Open Graph',
    },
    links: {
      title: 'Vínculos',
      ...
      internal: 'Internos',
      external: 'Externos',
      insecure: 'Inseguros (http://)',
    },
    supplyChain: {
      title: 'Cadena de suministro',
      thirdPartyScripts: 'Scripts de terceros',
      nonGovScriptsOnGov: 'Scripts no gubernamentales en sitio gov',
      inlineScripts: 'Scripts en línea',
      nonGovResourcesOnGov: 'Recursos no gubernamentales en sitio gov',
    },
    pageInternals: {
      title: 'Internos de página',
      htmlComments: 'Comentarios HTML',
      flaggedComments: 'Comentarios marcados',
      commentSample: 'Muestra',
      techStack: 'Plataforma detectada',
      versionDisclosed: 'Versión expuesta en la página',
